...
#ifndef SAMPLEROBOTCONTROLLER_H
#define SAMPLEROBOTCONTROLLER_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  SampleRobotController(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void SampleRobotControllerInit(RTC::Manager* manager);
};

#endif // SAMPLEROBOTCONTROLLER_H
