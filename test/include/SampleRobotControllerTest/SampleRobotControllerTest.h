// -*- C++ -*-
/*!
 * @file  SampleRobotControllerTest.h
...
#ifndef SAMPLEROBOTCONTROLLER_TEST__H
#define SAMPLEROBOTCONTROLLER_TEST_H
...
/*!
 * @class SampleRobotControllerTest
 * @brief SampleRobotController
 *
 */
class SampleRobotControllerTest
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  SampleRobotControllerTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~SampleRobotControllerTest();
 ...
 protected:
  ...
  /*!
   */
  InPort<RTC::TimedPose2D> m_estimatedPoseIn;
...
extern "C"
{
  DLL_EXPORT void SampleRobotControllerTestInit(RTC::Manager* manager);
};

#endif // SAMPLEROBOTCONTROLLER_TEST_H
